    ...
    */
    public function restore(Request $request)
    {
        ...
        */
        ...
        $id = $request->input("id");
        try {
            Ordinances::withTrashed()->find($id)->restore();

            # return all the trashed data
            return response()->json(["ordinances" => Ordinances::onlyTrashed()->get(), "res" => ["msg" => "successfully restore data", "status" => 200]], 200);
        } catch (\Throwable $err) {
            //throw $th;
        ...
        */
        ...
        try {
            ...
            if ($request->file("pdfFile")) {
                ...
                # then update the db for the new path of the file
