...
class MayorClearanceController extends Controller
{
    /*
    * office of the mayor
    * get all the data for scholarship program
    */
    public function getMayorClearance()
    {
        return response()->json(["mayor_clearance" => Service::where("service_type", "=", "mayor clearance")->get()]);
    }
    ...
    public function createRequirement(Request $request)
    {
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'mayor_clearance' => Service::where("service_type", "=", "mayor clearance")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
