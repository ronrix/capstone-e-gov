...
class TreatmentVacinnationOfAnimals extends Controller
{
    /*
    * mswd
    ...
    */
    ...
    {
        return response()->json(["treatment_vaccination" => Service::where("service_type", "=", "treatment and vaccination of animals")->get()]);
    }
    ...
    public function createRequirement(Request $request)
    {
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'treatment_vaccination' => Service::where("service_type", "=", "treatment and vaccination of animals")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
