...
class IssuanceOfMOACertification extends Controller
{
    /*
    * mswd
    ...
    */
    ...
    {
        return response()->json(["issuance_moa" => Service::where("service_type", "=", "issuance of moa certification")->get()]);
    }
    ...
    public function createRequirement(Request $request)
    {
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'issuance_moa' => Service::where("service_type", "=", "issuance of moa certification")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
