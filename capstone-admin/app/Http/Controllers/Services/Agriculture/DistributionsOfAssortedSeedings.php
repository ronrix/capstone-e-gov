...
class DistributionsOfAssortedSeedings extends Controller
{
    /*
    * mswd
    ...
    */
    ...
    {
        return response()->json(["distributions_seeds" => Service::where("service_type", "=", "distributions of assorted seeds")->get()]);
    }
    ...
    public function createRequirement(Request $request)
    {
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'distributions_seeds' => Service::where("service_type", "=", "distributions of assorted seeds")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
