...
class DeliveryOfFarmsFisheryInputs extends Controller
{
    /*
    * mswd
    ...
    */
    ...
    {
        return response()->json(["delivery_farms" => Service::where("service_type", "=", "delivery of farm and fishery inputs")->get()]);
    }
    ...
    public function createRequirement(Request $request)
    {
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'delivery_farms' => Service::where("service_type", "=", "delivery of farm and fishery inputs")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
