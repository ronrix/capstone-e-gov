...
class TechnicalAssistanceForFarmers extends Controller
{
    /*
    * mswd
    ...
    */
    ...
    {
        return response()->json(["technical_assistance" => Service::where("service_type", "=", "technical assistance for farmers")->get()]);
    }
...
*/
    ...
    */
        ...
        try {
            ...
            return response()->json([
                'technical_assistance' => Service::where("service_type", "=", "technical assistance for farmers")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
