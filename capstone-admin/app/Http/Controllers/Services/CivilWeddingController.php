...
class CivilWeddingController extends Controller
{
    /*
    * office of the mayor
    * get all the data for scholarship program
    */
    public function getCivilWedding()
    {
        return response()->json(["civil" => Service::where("service_type", "=", "civil wedding")->get()]);
    }
    ...
    public function createRequirement(Request $request)
    {
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'civil' => Service::where("service_type", "=", "civil wedding")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
