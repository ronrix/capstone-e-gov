...
class MSWDController extends Controller
{
    ...
    */
    ...
    {
        return response()->json(["government_id" => Service::where("service_type", "=", "government id")->get()]);
    }
    ...
    * get all the data for government id
    */
    public function getSeniorCitizen()
    {
        return response()->json(["senior_citizen" => Service::where("service_type", "=", "replacement of senior citizen")->get()]);
    }
    ...
    public function createRequirement(Request $request)
    {
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'government_id' => Service::where("service_type", "=", "government id")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
    ...
    * update one requirement
    */
    public function updateRequirementSenior(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
    ...
    * create new requirement and append that to the existing requirements
    */
    public function createRequirementSenior(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'senior_citizen' => Service::where("service_type", "=", "replacement of senior citizen")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
    ...
    * delete one requirement
    */
    public function deleteRequirementSenior(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
    ...
    * update one process
    */
    public function updateProcessSenior(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
    ...
    * delete one process
    */
    public function deleteProcessSenior(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
    ...
    * create new requirement and append that to the existing requirements
    */
    public function createProcessSenior(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
