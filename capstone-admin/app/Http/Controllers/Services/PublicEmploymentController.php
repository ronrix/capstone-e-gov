...
class PublicEmploymentController extends Controller
{
    /*
    * mswd
    ...
    */
    ...
    {
        return response()->json(["job_fair" => Service::where("service_type", "=", "job fair")->get()]);
    }
    ...
    */
    ...
    {
        return response()->json(["spes" => Service::where("service_type", "=", "special program employment for students")->get()]);
    }
    ...
    public function createRequirement(Request $request)
    {
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'job_fair' => Service::where("service_type", "=", "job fair")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
    ...
    * update one requirement
    */
    public function updateRequirementSPEs(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
    ...
    * create new requirement and append that to the existing requirements
    */
    public function createRequirementSPES(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
        ...
        */
        ...
        try {
            ...
            return response()->json([
                'spes' => Service::where("service_type", "=", "special program employment for students")->get(),
                "res" => [
                    "msg" => "Successfully added new requirement",
                    "status" => 200
                ]
    ...
    * delete one requirement
    */
    public function deleteRequirementSPES(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
    ...
    * update one process
    */
    public function updateProcessSPES(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
    ...
    * create new requirement and append that to the existing requirements
    */
    public function createProcessSPES(Request $request)
    {
        // validate
        $validator = Validator::make($request->all(), [
            "rowId" => "required",
