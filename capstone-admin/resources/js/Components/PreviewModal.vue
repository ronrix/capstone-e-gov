<template>
  <div class="fixed top-0 left-0 right-0 bottom-0 bg-black/20 flex items-center justify-center z-30">
    <form @submit.prevent="onSubmit"
      class="backdrop-blur-xl bg-white/70 h-full sm:h-auto sm:w-[1000px] p-5 rounded-lg flex flex-col sm:flex-row border overflow-y-scroll scrollbar"
      ...
      <div
        ...
        <div
          class="overflow-hidden flex-1 h-full flex items-center justify-center w-full border-2 border-blue-600 rounded-md">
        ...
        <div
          class="flex-1 flex flex-wrap sm:flex-row items-start gap-2 overflow-y-scroll sm:overflow-x-scroll scrollbar py-2 w-full el-main h-[100px] sm:h-auto">
