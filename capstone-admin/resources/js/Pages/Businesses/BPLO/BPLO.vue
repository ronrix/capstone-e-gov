<template>
  ...
  <WrapperContent>
    ...
    <BPermit v-for="permit in dataRequirements" :key="permit.id" :tableId="permit.id" :permit="permit" class="mb-3"
      :handle-update-permit="handleUpdatePermit" :handleDeleteWholePermit="handleDeleteWholePermit" />
...
async function handleUpdatePermit(formData, tableId) {
  return await axios
