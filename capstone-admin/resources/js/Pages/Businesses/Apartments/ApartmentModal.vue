...
<template>
    <div class="fixed top-0 left-0 right-0 bottom-0 bg-black/20 flex item-center justify-center z-20"> 
        <div class="bg-white sm:w-[700px] p-5 rounde-lg relative flex flex-col md:flex-row items-start">
            <!--close modal button-->
            <i @click="showAppartmentModal" class="uil uil-times text-black hover:text-blue-500 text-xl absolute top-0 right-2 cursor-pointer"></i>
            ...
            <div class="overflow-hidden mt-5 group relative h-[50px] md:h-auto w-full md:w-1/2">
             <!--hover design-->
                ...
                <img :src="selectedData?.img" alt="This is the thunbnail of Apartment">
            </div>
         ...
         <div class="flex-1 p-3 w-full">
            <!--Title-->
            <h4 @click="stopEditing" class="font-bold text-xl flex items-center whitespace-pre-wrap">
         ...
         <!--type-->
         <h5 class="text-xs text-gray-500 font-bold">{{ type }}</h5>
         <!-- content -->
