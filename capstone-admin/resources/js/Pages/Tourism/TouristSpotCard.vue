    ...
    <div
        ...
        <div class="flex-1 flex flex-col gap-3 items-start justify-between ">
            ...
            <div class="flex">
                ...
                <p class="text-ellipsis overflow-hidden pt-1" style="font-size: 12px;">{{ data.location }}</p>
            </div>
        </div>
        <!-- content -->
        <div class="flex-1 p-5 flex flex-col items-start justify-between">
            <h3 class="font-bold uppercase text-xl tracking-wide">{{ data.name }}</h3>
...
const imgSrc = formatImgs(data.img_link.split(","));
