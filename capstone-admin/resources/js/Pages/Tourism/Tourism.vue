    ...
    <WrapperContent>
        ...
        <div class="flex items-start gap-5 justify-start flex-wrap">
            ...
            <div v-for="data in filteredData" class="card1 flex flex-col h-[350px] w-full md:w-auto">
                <img class="text-center h-[150px]" :src="data.img">
                ...
                <button @click="showTouristSpotPreviewModal(data)" class="mb-2 mr-2 bg-blue-600 hover:bg-blue-500 px-3 py-2 text-white font-bold text-xs self-end  uppercase">view </button>
            </div>
        </div>
        <!-- TouristSpotPreviewModal -->
...
},
{
    ...
    img: "https://lh3.googleusercontent.com/p/AF1QipPRhIWwjDgt5B4_SSlVH1H7u6ZhFxrzI99tEODy=s1600-w400"

},
{
    placeName: "CHRIST THE REDEEMER",
    address: "Niogan, Pililla Rizal",
    img: "https://scontent.fmnl25-2.fna.fbcdn.net/v/t1.6435-9/42959646_238629530151335_2789232954084163584_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=8bfeb9&_nc_eui2=AeETBr01BWL803J9tLwMAD_6T2PzFTIwsDFPY_MVMjCwMU1mrMZnmolLM_kJupCD0_qYddMaOWuXSDfPRBuXLfmT&_nc_ohc=Y6Bx06NsEH8AX884gGt&_nc_ht=scontent.fmnl25-2.fna&oh=00_AfA0wCs9h4M1qbqO9RjdyOynBrsVTN0a4MfLH6DiFI1E_Q&oe=6437C55D"
