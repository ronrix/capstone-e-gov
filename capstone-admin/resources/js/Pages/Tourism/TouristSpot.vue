<template>
  <WrapperContent class="flex flex-col gap-5">
    ...
    <div class="flex-1 p-5 flex flex-col items-start justify-between">
      ...
      <!-- PreviewButton -->
      <button @click="showTouristSpotPreviewModal(data)" class="bg-blue-600 hover:bg-blue-500 px-3 py-2 text-white font-bold text-xs self-end mt-20 uppercase">edit</button>
    </div>
  </div>
