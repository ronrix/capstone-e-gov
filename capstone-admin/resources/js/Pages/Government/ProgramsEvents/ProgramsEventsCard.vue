<template>
  <div class="relative bg-white p-5 flex flex-col md:flex-row border border-r-0 border-y-0 border-l-[5px] border-l-blue-600 overflow-hidden shadow-md">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <button @click="showPreviewModal(data)" class="bg-blue-600 hover:bg-blue-500 px-3 py-2 text-white font-bold text-xs self-end mt-5 uppercase rounded-md">view </button>
    </div>
  </div>
</template>
