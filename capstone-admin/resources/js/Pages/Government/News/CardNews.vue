<template>
  <div class="relative overflow-hidden flex flex-col md:flex-row shadow-md bg-white border border-r-0 border-y-0 border-l-[5px] border-l-blue-600">
    ...
    <div class="flex-1 px-5 pt-5 flex flex-col justify-between">
      ...
      <p class="mt-5 text-sm h-[100px] overflow-hidden" v-bind:innerHTML="description">
