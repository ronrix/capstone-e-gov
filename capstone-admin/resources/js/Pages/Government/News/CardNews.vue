<template>
  <div class="flex flex-col md:flex-row items-start shadow-lg bg-white rounded-lg">
    <!-- image -->
    <div :style="{ backgroundImage: `url(${data.img})` }" class="bg-no-repeat bg-cover bg-center h-[300px] w-full md:w-[300px] lg:w-[500px] relative after:h-[50px] after:bottom-0 after:w-full after:bg-gradient-to-t after:from-black/80 after:to-white/10 after:absolute after:blur-sm"> </div>
    <!-- content -->
