<template>
  <div class="flex items-center justify-center flex-col gap-2">
    ...
    <h3 class="text-center font-['display'] text-4xl sm:w-1/2 text-darkgray mt-5">
    ...
    <div class="flex items-center gap-5 mt-5">
      <button class="text-sm sm:text-base px-3 py-2 bg-primary font-bold hover:bg-primarylight text-white rounded-md">
        Apply for Benefits
      </button>
      <button class="text-sm sm:text-base px-3 py-2 bg-white font-bold rounded-md hover:bg-gray-200">
        Am I Eligible?
      </button>
    </div>
  </div>
