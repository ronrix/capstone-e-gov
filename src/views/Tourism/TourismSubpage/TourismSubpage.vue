...
<template>
  ...
  <div class="flex justify-between p-28 pt-5">
    <div>
      ...
      <p>CHURCH</p>
      <P class="text-2xl font-semibold w-80"
        >The Diocesan Shrine and Parish of St. Mary Magdalene</P
      >
      <img
        src="https://boyplakwatsa.files.wordpress.com/2014/04/rizal-tour-march-15-2014-orig-011.jpg"
        alt=""
      />
      <p class="text-sm w-[750px] mt-4">
    ...
    <div class="" style="border-left: 2px solid gray; right: 50%; height: auto; padding-left: 35px">
          ...
          <div class="flex h-auto w-96 bg-white drop-shadow-md group-hover:opacity-80">
            ...
            <div class="grid p-2">
              <h2 class="font-semibold">
                {{ data.placeName }}<span class="block text-xs font-normal">{{ data.date }}</span>
              </h2>
