<template>
  <div class="grid place-items-center mt-10 justify-center">
    ...
    <div class="flex relative">
      ...
      <img
        class="w-[210px] absolute right-36 top-3"
    ...
    <div
      class="flex justify-evenly gap-32 h-auto w-[1200px] absolute top-[320px] text-center p-3 text-white"
      style="background-color: rgb(185, 43, 39);"
    >
      <div
        class="text-[13px] font-['montserrat']"
        style="border-right: 2px solid white; right: 50%; height: 50px; padding-right: 35px; margin-top: 10px;"
      >
      ...
      <div
        class="text-[13px] font-['montserrat']"
        style="border-left: 2px solid white; right: 50%; height: 50px; padding-left: 35px; margin-top: 10px;"
      >
        <p class="pt-2 w-[250px]">
          “ Pamunuang mapagmahal at mapagkalinga ”
        </p>
      </div>
    </div>
    <div class="relative bottom-10 ">
      <img
        class="object-cover w-[1200px] "
  ...
  <div class="flex justify-between items-center pr-[75px] pl-[75px]">
    <p class="font-['display']  text-[30px] font-semibold w-72">
      Find your best destination.
    </p>
    <div>
      <p class="text-[12px] pb-[2px]">
        We have more destination you can
      </p>
      <div class="relative">
        <input
