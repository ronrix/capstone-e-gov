...
<template>
  ...
  <WrapperContainer>
    ...
    <div class="flex justify-center relative">
      <img class="w-[600px] absolute bg-center object-cover -z-10" src="../../../public/images/Tourismbg-Circle.png" />
      <div class="flex pt-5">
        <img class="sm:w-[210px] w-[160px] z-10 object-cover" src="https://www.pngaaa.com/api-download/1853846" alt="" />
        <img class="sm:w-[200px] w-[100px] -translate-x-14 object-cover"
  ...
  <div class="flex justify-between h-auto w-full text-white bg-primary items-center p-5 -translate-y-5 sm:-translate-y-0">
  ...
  <div class="w-full sm:pt-10 pb-10">
    <img class="w-full object-cover"
      src="https://pilillarizal.gov.ph/wp-content/uploads/2022/10/pililla_painting-1024x326.png" alt="" />
  </div>
    ...
    <div class="flex justify-between items-center">
      ...
      <div>
        ...
        <form
          ...
          <input v-model="searchInput" class="bg-transparent w-full outline-none" type="text"
  ...
  <WrapperContainer>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-10 gap-5">
      <RouterLink v-for="data in tourism" :key="data.id" :to="'/tourist-attractions/' +
        data.title.replace(/\s+/g, '_').replace(/\n/g, ' ').toLowerCase()
        " class="flex flex-col border hover:drop-shadow-lg bg-white dark:bg-dark">
        <img class="object-cover h-[250px] w-full" :src="formatImgs(data.img_link.split(','))" alt="" />
        <div class="py-5 px-3">
